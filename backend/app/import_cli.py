...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Import Barclays .xls portfolio snapshot")
    parser.add_argument("file_path", type=Path, help="Path to LoadDocstore.xls")
...
async def _run() -> None:
    ...
    if args.file_path.suffix.lower() != ".xls":
        raise SystemExit("Only .xls files are supported for Barclays import.")
